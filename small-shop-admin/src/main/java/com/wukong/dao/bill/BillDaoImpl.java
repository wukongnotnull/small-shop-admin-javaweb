...
public class BillDaoImpl implements BillDao {
	...
	public int add(Connection connection, Bill bill) throws Exception {
		...
		int flag = 0;
		if(null != connection){
			String sql = "insert into shop_bill (billCode,productName,productDesc," +
	...
	public int modify(Connection connection, Bill bill) throws Exception {
		...
		PreparedStatement pstm = null;
		if(null != connection){
			String sql = "update shop_bill set productName=?," +
	...
	public int getBillCountByProviderId(Connection connection, String providerId)
		...
		ResultSet rs = null;
		if(null != connection){
			String sql = "select count(1) as billCount from shop_bill where" +
					"	providerId = ?";
