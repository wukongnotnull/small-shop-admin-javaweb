...
insert  into `shop_address`(`id`,`contact`,`addressDesc`,`postCode`,`tel`,`createdBy`,`creationDate`,`modifyBy`,`modifyDate`,`userId`) 
...
/*Data for the table `shop_bill` */

insert  into `shop_bill`(`id`,`billCode`,`productName`,`productDesc`,`productUnit`,`productCount`,`totalPrice`,`isPayment`,`createdBy`,`creationDate`,`modifyBy`,`modifyDate`,`providerId`) 
values (1,'BILL2016_001','洗发水、护发素','日用品-洗发、护发','瓶','500.00','25000.00',2,1,'2014-12-14 13:02:03',NULL,NULL,13),
...
insert  into `shop_role`(`id`,`roleCode`,`roleName`,`createdBy`,`creationDate`,`modifyBy`,`modifyDate`) 
values (1,'shop_ADMIN','系统管理员',1,'2016-04-13 00:00:00',NULL,NULL),
       (2,'shop_MANAGER','经理',1,'2016-04-13 00:00:00',NULL,NULL),
       (3,'shop_EMPLOYEE','普通员工',1,'2016-04-13 00:00:00',NULL,NULL);
...
insert  into `shop_user`(`id`,`userCode`,`userName`,`userPassword`,`gender`,`birthday`,`phone`,`address`,`userRole`,`createdBy`,`creationDate`,`modifyBy`,`modifyDate`) 
